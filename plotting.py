...
<div class="custom-header">
  ...
  <div class="nav">
    <a href="?page={page}&lang={lang}" target="_self" class="{{'active' if page=='Overview' else ''}}">
      {texts['nav_overview']}
    </a>
    <a href="?page={page}&lang={lang}" target="_self" class="{{'active' if page=='About' else ''}}">
      {texts['nav_about']}
    </a>
  </div>
  <div class="nav" style="margin-left:auto;">
    <a href="?page={page}&lang={toggle_lang}" target="_self" title="{toggle_tooltip}">
      {toggle_label}
    </a>
  </div>
</div>
...
if page == "Overview":
    ...
    st.divider()
    expander_label = side_texts["sidebar_header"].lstrip("# ").strip()
