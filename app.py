...
<div class="custom-header">
  ...
  <div class="nav">
    <a href="?page=Overview&lang={lang}" target="_self" rel="noopener"
       class="{{'active' if page=='Overview' else ''}}">{texts['nav_overview']}</a>
    <a href="?page=About&lang={lang}" target="_self" rel="noopener"
       class="{{'active' if page=='About' else ''}}">{texts['nav_about']}</a>
  </div>
  <div class="nav" style="margin-left:auto;">
    <a href="?page={page}&lang={toggle_lang}" target="_self" rel="noopener"
